...
public class Constants {
	...
	// suiteNames
	public static String PORTFOLIO_SUITE="PortFolio_Suite";
	public static String STOCK_SUITE="Stock_Suite";
	...
	public static String EXPECTED_RESULT_COL="Expected_Result";
