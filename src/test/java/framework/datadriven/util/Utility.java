...
public class Utility {
	...
	// #########################################   I S    T E S T C A S E    R U N N A B L E   ########################################
	...
	public static Object[][]  getData(String testName, Xls_Reader xls){
		...
		// Get datasheet rows count
		int rows = xls.getRowCount(Constants.DATA_SHEET);
		System.out.println("Total rows in datasheet - "+ rows);
		...
		Object[][] data = new Object[testRows][1]; // only 1 column
		int r=0;
